...
<x-app-layout>
    <div class="container mx-auto p-4">
        <div class="card mx-auto">
            ...
            <p class="mt-2">Total Price: {{ $product->quantity * $product->price }}$</p>
            <div class="flex justify-between mt-2">
                <div><button class="button px-2 py-1 bg-blue-500  text-white font-bold rounded"><a href="{{ route('product.edit', $product->id) }}" class="button px-2 py-1 bg-blue-500 text-white font-bold rounded">Edit</a></button></div>
